    ...
    <div style={{
      ...
      <main style={styles.main}>
        ...
        <div style={styles.pageHeader}>
          ...
          <h1 style={{ ...styles.pageTitle, color: colors.heading }}>Our Work</h1>
        ...
        <div style={styles.searchWrapper}>
          <div style={{ 
            ...
            {searchQuery && (
              <button onClick={clearSearch} style={styles.clearButton}>
                <X size={16} color={colors.tertiaryText} />
              </button>
            )}
          </div>
          <button style={{ 
            ...
            <Filter size={18} color={colors.secondaryText} />
          </button>
        </div>
          ...
          {categories.map((category) => (
            <button
              ...
              style={{
                ...
                backgroundColor: activeCategory === category ? colors.primary : colors.cardBg,
                color: activeCategory === category ? colors.btnText : colors.secondaryText,
              }}
            >
              {category}
            </button>
        ...
        {/* Results Count */}
        <div style={{ ...styles.resultsCount, color: colors.tertiaryText }}>
          <span>{filteredDesigns.length} designs found</span>
        </div>
        ...
        <div style={styles.galleryGrid}>
          {filteredDesigns.map((design) => (
            ...
            >
              ...
              <div style={styles.meta}>
                <div style={{ ...styles.name, color: colors.heading }}>{design.name}</div>
                <div style={{ ...styles.price, color: colors.primary }}>{design.price}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        {filteredDesigns.length === 0 && (
          <div style={styles.emptyState}>
            <Grid3x3 size={48} color={colors.tertiaryText} />
            <h3 style={{ ...styles.emptyTitle, color: colors.heading }}>No designs found</h3>
            <p style={{ ...styles.emptyText, color: colors.secondaryText }}>
              Try adjusting your search or filter to find what you're looking for.
            </p>
          </div>
        )}
