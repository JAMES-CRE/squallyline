...
//   main: {
//     width: '100%',
//     maxWidth: '800px', // ← Increased from 540px
//     margin: '0 auto',
//   },
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div
                  style={{
                    ...
                    backgroundColor: colors.border,
                    ...(step.status === 'completed' || step.status === 'current'
                      ? { ...styles.stepLineActive, backgroundColor: colors.success }
                      : {}),
                  }}
                />
              )}
              ...
              <div style={styles.stepDotWrapper}>
                <div
                  style={{
                    ...styles.stepDot,
                    backgroundColor: getStatusColor(step.status),
                    ...(step.status === 'current' ? { ...styles.stepDotCurrent, boxShadow: `0 0 0 4px ${colors.primary}33` } : {}),
                  }}
                >
                  {step.status === 'completed' && (
                    <CheckCircle size={14} color="#FFFFFF" />
              ...
              <div style={styles.stepContent}>
                ...
                <span
                  style={{
                    ...styles.stepBadge,
                    ...(step.status === 'completed' ? { ...styles.stepBadgeCompleted, backgroundColor: colors.successBg, color: colors.success } : {}),
                    ...(step.status === 'current' ? { ...styles.stepBadgeCurrent, backgroundColor: colors.primaryLight, color: colors.primary } : {}),
                    ...(step.status === 'pending' ? { ...styles.stepBadgePending, backgroundColor: colors.border, color: colors.tertiaryText } : {}),
                  }}
                >
                  {getStatusLabel(step.status)}
                </span>
