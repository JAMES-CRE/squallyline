    ...
    <div style={{
      ...
      <main style={styles.main}>
        ...
        <div style={styles.cardHeader}>
          ...
          <h1 style={{ ...styles.title, color: colors.heading }}>Create Account</h1>
          <p style={{ ...styles.subtitle, color: colors.secondaryText }}>
            Join Squallyline and manage your measurements, bookings, and orders.
          </p>
        </div>
        
        {serverError && (
          <div style={{ ...styles.alertError, backgroundColor: colors.errorBg, color: colors.error, borderColor: colors.errorBg }}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.formRow}>
            <div style={styles.formGroup}>
              <label style={{ ...styles.label, color: colors.heading }}>First Name</label>
              <div style={{ 
                ...styles.inputWrapper, 
                borderColor: getFieldError('first_name') ? colors.error : colors.border,
              ...
              {getFieldError('first_name') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.first_name}</span>}
            </div>
            
            <div style={styles.formGroup}>
              <label style={{ ...styles.label, color: colors.heading }}>Last Name</label>
              <div style={{ 
                ...styles.inputWrapper, 
                borderColor: getFieldError('last_name') ? colors.error : colors.border,
                backgroundColor: colors.cardBg,
              }}>
                <User size={18} color={colors.tertiaryText} style={styles.inputIcon} />
                <input
              ...
              {getFieldError('last_name') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.last_name}</span>}
            </div>
          </div>
          
          <div style={styles.formGroup}>
            <label style={{ ...styles.label, color: colors.heading }}>Username</label>
            <div style={{ 
              ...styles.inputWrapper, 
              borderColor: getFieldError('username') ? colors.error : colors.border,
              backgroundColor: colors.cardBg,
            }}>
              <User size={18} color={colors.tertiaryText} style={styles.inputIcon} />
              <input
            ...
            {getFieldError('username') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.username}</span>}
          </div>
          
          <div style={styles.formGroup}>
            <label style={{ ...styles.label, color: colors.heading }}>Email</label>
            <div style={{ 
              ...styles.inputWrapper, 
              borderColor: getFieldError('email') ? colors.error : colors.border,
              backgroundColor: colors.cardBg,
            }}>
            ...
            {getFieldError('email') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.email}</span>}
          </div>
          
          <div style={styles.formGroup}>
            <label style={{ ...styles.label, color: colors.heading }}>Phone Number</label>
            <div style={{ 
              ...styles.inputWrapper, 
              borderColor: getFieldError('phone_number') ? colors.error : colors.border,
              backgroundColor: colors.cardBg,
            }}>
              <Phone size={18} color={colors.tertiaryText} style={styles.inputIcon} />
              <input
                type="tel"
                name="phone_number"
                value={formData.phone_number}
            ...
            {getFieldError('phone_number') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.phone_number}</span>}
          </div>
          ...
          <div style={styles.formGroup}>
            ...
            <div style={{ 
              ...styles.inputWrapper, 
              borderColor: getFieldError('password') ? colors.error : colors.border,
              backgroundColor: colors.cardBg,
            }}>
            ...
            {getFieldError('password') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.password}</span>}
            <span style={{ ...styles.helperText, color: colors.tertiaryText }}>
              8+ characters with uppercase, lowercase, number, and special character
            </span>
          </div>
          
          <div style={styles.formGroup}>
            <label style={{ ...styles.label, color: colors.heading }}>Confirm Password</label>
            <div style={{ 
              ...styles.inputWrapper, 
              borderColor: getFieldError('password_confirm') ? colors.error : colors.border,
              backgroundColor: colors.cardBg,
            }}>
              <Lock size={18} color={colors.tertiaryText} style={styles.inputIcon} />
              <input
              ...
              <button
                ...
                style={styles.eyeButton}
              >
                {showConfirmPassword ? <EyeOff size={18} color={colors.tertiaryText} /> : <Eye size={18} color={colors.tertiaryText} />}
              </button>
            </div>
            {getFieldError('password_confirm') && <span style={{ ...styles.errorText, color: colors.error }}>{errors.password_confirm}</span>}
          </div>
          
          <div style={styles.formGroup}>
            <label style={{ ...styles.label, color: colors.heading }}>Account Type</label>
            <div style={styles.roleOptions}>
              <button
                type="button"
                style={{
                  ...
                  backgroundColor: formData.role === 'customer' ? colors.primaryLight : colors.cardBg,
                  color: formData.role === 'customer' ? colors.primary : colors.secondaryText,
                }}
                onClick={() => setFormData(prev => ({ ...prev, role: 'customer' }))}
              >
                <User size={16} />
              ...
              <button
                ...
                style={{
                  ...styles.roleBtn,
                  borderColor: formData.role === 'tailor' ? colors.primary : colors.border,
                  backgroundColor: formData.role === 'tailor' ? colors.primaryLight : colors.cardBg,
                  color: formData.role === 'tailor' ? colors.primary : colors.secondaryText,
                }}
                onClick={() => setFormData(prev => ({ ...prev, role: 'tailor' }))}
              >
                <UserCheck size={16} />
        ...
        <div style={styles.footer}>
          <p style={{ color: colors.secondaryText }}>
            Already have an account? <Link to="/login" style={{ ...styles.footerLink, color: colors.primary }}>Log in</Link>
          </p>
        </div>
      </main>
    </div>
