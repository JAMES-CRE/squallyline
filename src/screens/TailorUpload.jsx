      ...
      <main style={styles.main}>
        ...
        <div style={styles.formGroup}>
          <label style={{
            ...
            <Tag size={16} color={colors.secondaryText} style={styles.labelIcon} />
            Design Name
          </label>
          <input
            type="text"
        ...
        <div style={styles.formGroup}>
          <label style={{
            ...
            <Scissors size={16} color={colors.secondaryText} style={styles.labelIcon} />
            Category
          </label>
          <select
            name="category"
        ...
        <div style={styles.formGroup}>
          <label style={{
            ...
            <DollarSign size={16} color={colors.secondaryText} style={styles.labelIcon} />
            Price Estimate
          </label>
          <input
            type="text"
